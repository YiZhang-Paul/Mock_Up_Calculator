...
namespace MockUpCalculator {
    public partial class MainForm : Form {
        ...
        protected void ToTimeConverterPanel() {

            ToConverter("Time", ServiceLookup.GetTimeConverterPanel);
        }

        protected void ToPowerConverterPanel() {

            ToConverter("Power", ServiceLookup.GetPowerConverterPanel);
        }

        protected void ToDataConverterPanel() {

            ToConverter("Data", ServiceLookup.GetDataConverterPanel);
        }

        protected void ToPressureConverterPanel() {

            ToConverter("Pressure", ServiceLookup.GetPressureConverterPanel);
        }
        ...
        protected virtual void SelectCalculator(object sender, EventArgs e) {
            ...
            switch(selection) {
                ...
                case "Time":
                    ...
                    ToTimeConverterPanel();

                    break;

                case "Power" :

                    ToPowerConverterPanel();

                    break;

                case "Data" :

                    ToDataConverterPanel();

                    break;

                case "Pressure" :

                    ToPressureConverterPanel();
